                            ...
                            <tr>
                                <td style="padding: 0 30px">
                                    ...
                                    <p style="margin-bottom: 10px;">If the button above does not work, paste this link into your web browser:</p>
                                     <a href="{{verify_link}}" style="color: #6576ff; text-decoration:none;word-break: break-all;">{{verify_link}}</a>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="">techmindhelps.com</a>. To update your emails preferences <a style="color: #6576ff; text-decoration:none;" href="#">click here</a>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
